...
import com.scania.test.presentation.placeholder.PlaceholderContent.PlaceholderItem
 ...
 */
class MyJokeRecyclerViewAdapter(
    private val values: List<PlaceholderItem>
) : RecyclerView.Adapter<MyJokeRecyclerViewAdapter.ViewHolder>() {
